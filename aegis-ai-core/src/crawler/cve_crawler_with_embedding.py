...
from src.rag.local_embedding import SENTENCE_TRANSFORMERS_AVAILABLE, LocalEmbedder
...
class CVECrawlerWithCustomEmbedding(CVECrawler):
    ...
    def __init__(
        self,
        db_path: str = "./aegis_db",
        collection_name: str = "cve_core",
...
def main():
    ...
    parser.add_argument("--model", type=str, default="paraphrase-multilingual-MiniLM-L12-v2", help="向量化模型名称")
