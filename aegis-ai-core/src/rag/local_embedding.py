...
try:
    ...
    logger.warning("sentence-transformers 未安装，将使用 ChromaDB 默认向量化。安装命令: pip install sentence-transformers")
...
def get_global_embedder(model_name: str = DEFAULT_MODEL) -> Optional[LocalEmbedder]:
    """
    获取全局向量化器实例（单例模式）
