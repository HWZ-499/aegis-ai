...
class IncrementalScanner:
    ...
    def __init__(self, project_path: str, base_ref: Optional[str] = None):
        """
        初始化增量扫描器
...
def scan_incremental(project_path: str, base_ref: Optional[str] = None, verbose: bool = False) -> Dict[str, List[Dict]]:
    """
    便捷函数：执行增量扫描
