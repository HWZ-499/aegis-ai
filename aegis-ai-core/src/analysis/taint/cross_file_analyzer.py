...
class CrossFileAnalyzer:
    ...
    def __init__(self, project_path: Path):
        ...
        self._py_parser: Optional[Parser] = None
    ...
    def _traverse_js_ast(self, node: Any, file_path: str) -> None:
                ...
                if args:
                    for arg in args.children:
                        if arg.type == "string":
                            ...
                            self._imports[file_path].append(ModuleImport(
        ...
        # 处理 module.exports
            ...
            if left and "module.exports" in self._get_node_text(left):
                line = node.start_point[0] + 1
                self._exports[file_path].append(ModuleExport(
                    name="default",
    ...
    def _resolve_relative_path(self, base_dir: Path, module_path: str) -> Optional[Path]:
        """解析相对模块路径"""
        # 移除 ./ 或 ../ 前缀并计算路径
    ...
    def _find_module_in_project(self, module_name: str) -> Optional[Path]:
        """在项目中查找模块"""
        # 将模块名转换为路径
            ...
            for imp in imports:
                ...
                for export in source_exports:
                    ...
                    if export.tainted_params:
                        paths.append(CrossFileTaintPath(
    ...
    def get_module_info(self, file_path: str) -> Dict[str, Any]:
        ...
        return {
            "exports": [
                {"name": e.name, "type": e.export_type.name, "line": e.line}
                for e in self._exports.get(file_path, [])
            ],
            "imports": [
                {
    ...
    @staticmethod
    def _get_child_by_type(node: Any, type_name: str) -> Optional[Any]:
        """按类型获取子节点"""
        for child in node.children:
    ...
    @staticmethod
    def _get_child_by_field(node: Any, field_name: str) -> Optional[Any]:
        """按字段名获取子节点"""
