...
exports.showTaintPathPanel = showTaintPathPanel;
exports.disposeTaintPathPanel = disposeTaintPathPanel;
const vscode = __importStar(require("vscode"));
let currentPanel;
/**
 * Show or reuse the Taint Path Webview panel.
 */
function showTaintPathPanel(extensionUri, data) {
    ...
    currentPanel = vscode.window.createWebviewPanel("aegisTaintPath", `Taint Path: ${data.vulnType}`, column, { enableScripts: true, retainContextWhenHidden: false });
    currentPanel.webview.html = buildHtml(currentPanel.webview, data);
 ...
 */
function disposeTaintPathPanel() {
...
function buildHtml(_webview, data) {
    ...
    const nodesHtml = nodes
        ...
        const edgeHtml = i < nodes.length - 1
...
//# sourceMappingURL=taintPathWebview.js.map